<#assign VOID = freeMarkerPortletPreferences.setValue("portletSetupPortletDecoratorId", "barebone")>
	<nav class="navbar navbar-expand-md navbar-light lfr-mutual-navigation" role="navigation">
		...
		<div class="form-inline order-md-2 col-xs-expand">
			...
			<div class="collapse search-toggle" id="searchCollapse">
				<div class="lfr-mutual-navigation-search">
		...
		<div class="collapse navbar-collapse order-md-1 lfr-mutual-navigation-menu" id="navbarCollapse">
			<@liferay.navigation_menu default_preferences="${freeMarkerPortletPreferences}" />
		</div>
	</nav>
